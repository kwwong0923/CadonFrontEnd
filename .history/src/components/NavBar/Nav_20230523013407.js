...
const Nav = () => {
    ...
    return (
        <nav className={styles.nav}>
            <ul>
                <li>
                    <a href="#" onClick={onLoginClickHandler}>Login</a>
                </li>
                {loginShown && <Login />
                }
                <li>
                ...
                { registerShown && <Register onRegisterClickHandler={onRegisterClickHandler} setRegisterSuccessfully={setRegisterSuccessfully}/>}
